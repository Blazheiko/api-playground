...
import ApiFilters from '@/components/api/ApiFilters.vue'
...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <ApiFilters @expand-all="handleExpandAll" @collapse-all="handleCollapseAll" />

      <!-- Loading State -->
      <div v-if="apiStore.isLoading" class="bg-white dark:bg-gray-800 rounded-lg p-8 text-center">
        <div
      ...
      <div v-else class="bg-white dark:bg-gray-800 rounded-lg p-8 text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No routes found</h3>
